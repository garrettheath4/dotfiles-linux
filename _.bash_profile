...
colorize_prompt() {
	...
	# (the \[ and \] in PSBgYel, PSFgBlk, and PSReCol indicate that those characters are
	...
	local PSReCol; PSReCol="\[$(tput sgr0   )\]"  # reset colors to defaults
	...
	export PS1="${PSBgColor}${PSFgBlk}[\u@\h:\W]${PSReCol}\$ "
}
